...
export const EditExercisePage = ({ exerciseToEdit }) => {
    ...
    const editExercise = async () => {
        ...
        if(response.status === 200){
            ...
            alert(`Failed to edit exercise, satus code = ${response.status}`);
        }
        history.push("/");
    };
    ...
    return (
        <div>
            <h2>Edit Exercise</h2>
            <p>Use the boxes below to edit name, reps, weight, unit, and/or date of an exercise entry. Click "Save" once you are done.</p>
